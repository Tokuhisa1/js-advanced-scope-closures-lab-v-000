// produceDrivingRange() - Calculates whether a given trip is within
// range. For example, "produceDrivingRange(10)" returns a function
// that will take two strings as arguments and returns a message
// stating whether the trip is in range. If foo =
